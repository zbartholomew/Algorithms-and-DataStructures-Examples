package com.zbartholomew.Sorting;

import java.util.Arrays;

// The Quick Sort is normally the fastest sorting algorithm

public class QuickSortCommented {
    ...
    public static void main(String[] args) {
        ...
        QuickSortCommented theSort = new QuickSortCommented(10);

        theSort.generateRandomArray();

        System.out.println(Arrays.toString(QuickSortCommented.theArray));
    ...
    QuickSortCommented(int newArraySize) {
